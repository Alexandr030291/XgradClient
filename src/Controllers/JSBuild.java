...
public class JSBuild {
    ...
    private static final String find_elements = ";let elem_array = document.evaluate(xpath, document.documentElement, null, XPathResult.ORDERED_NODE_SNAPSHOT_TYPE, null);";
